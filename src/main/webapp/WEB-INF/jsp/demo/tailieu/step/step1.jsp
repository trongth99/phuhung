...
<form method="POST" action="${contextPath }/danh-sach-khach-hang/upload-file" id='submitFormModal' enctype="multipart/form-data">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="modal-header">
			<h2>
				Tải danh sách ( <a href="${contextPath }/danh-sach-khach-hang/template" style="color: red;">Download template</a> )
			</h2>
		</div>
