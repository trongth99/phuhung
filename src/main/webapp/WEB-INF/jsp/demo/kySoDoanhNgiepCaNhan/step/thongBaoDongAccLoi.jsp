		...
		<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
			...
			<div class="row register-form">
				<div class="col-md-12" style="text-align: center;">
					<h4>Hiện tại hệ thống lỗi nên sau 60 phút kể từ thời điểm mở TKTT SeABank thì TKTT SeABank đã mở sẽ bị ngừng/ không thể giao dịch. Quý khách vui lòng tải ứng dụng ngân hàng điện tử SeAMobile để mở TKTT online và thực hiện lại quy trình kí điện tử nếu có thực hiện mở mới TKTT SeABank. </h4>
				</div>
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-12">
